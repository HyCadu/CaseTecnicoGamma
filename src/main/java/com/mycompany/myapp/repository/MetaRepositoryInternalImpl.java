...
class MetaRepositoryInternalImpl extends SimpleR2dbcRepository<Meta, Long> implements MetaRepositoryInternal {
    ...
    @Override
    public Flux<Meta> findByCriteria(com.mycompany.myapp.domain.criteria.MetaCriteria criteria, Pageable page) {
        return createQuery(page, null).all(); // Implementação simplificada
    }

    @Override
    public Mono<Long> countByCriteria(com.mycompany.myapp.domain.criteria.MetaCriteria criteria) {
