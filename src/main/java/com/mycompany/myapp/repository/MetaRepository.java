...
interface MetaRepositoryInternal {
    ...
    Flux<Meta> findByCriteria(com.mycompany.myapp.domain.criteria.MetaCriteria criteria, Pageable page);

    Mono<Long> countByCriteria(com.mycompany.myapp.domain.criteria.MetaCriteria criteria);
